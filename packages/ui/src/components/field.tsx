import { Label } from "@meteor/ui/components/label";
import { Separator } from "@meteor/ui/components/separator";
...
function Field({
  ...
  return (
    // biome-ignore lint/a11y/useSemanticElements: Field envuelve un único label+input+helper; <fieldset> impondría estilos UA y se reserva para FieldSet (agrupación lógica).
    <div
      role="group"
      data-slot="field"
